...
if(isset($_SERVER['DRUPAL_ENV'])){
  if ($_SERVER['DRUPAL_ENV'] == 'stage'){
      $databases = array (
      'default' =>
      array (
        'default' =>
        array (
          'database' => 'db_optimhealth',
          'username' => 'optim_user',
          'password' => 'optimhealth',
          'host' => '104.130.8.232',
          'port' => '',
          'driver' => 'mysql',
          'prefix' => 'opt_',
   ...
   }elseif ($_SERVER['DRUPAL_ENV'] == 'prod'){
      $databases = array (
      'default' =>
      array (
        'default' =>
        array (
          'database' => 'db_prod_optimhealth',
          'username' => 'optim_user',
          'password' => 'optimhealth',
          'host' => 'localhost',
          'port' => '',
...
//     ),
//   );
//  } elseif ( $_SERVER['DRUPAL_ENV'] == 'stage' ){
//     $databases = array (
//     'default' =>
//     array (
//       'default' =>
 ...
 *
 */
$drupal_hash_salt = 'PJXuNT3FDWF2VMlFQjb21CEgpBeK_vTIA0V1Xv9ljXc';
