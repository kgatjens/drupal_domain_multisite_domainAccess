...
<div class="row">
<?php 
if(isset($view->obj_tpl_data->research_items)){
	foreach($view->obj_tpl_data->research_items as $item){
		include_redirect_bot($item['node_id'],  $item['title']);
		include_card_news_events($item['title'], $item['excerpt'], $item['path'], null, null, 'Continue Reading');
	} 
}
 ?>
</div>