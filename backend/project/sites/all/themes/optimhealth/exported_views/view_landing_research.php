<?php
$view = new view();
$view->name = 'view_landing_research';
$view->description = '';
$view->tag = 'default';
$view->base_table = 'node';
$view->human_name = 'View Landing Research';
$view->core = 7;
...
/* Field: Content: Date */
$handler->display->display_options['fields']['field_research_date']['id'] = 'field_research_date';
$handler->display->display_options['fields']['field_research_date']['table'] = 'field_data_field_research_date';
$handler->display->display_options['fields']['field_research_date']['field'] = 'field_research_date';
$handler->display->display_options['fields']['field_research_date']['settings'] = array(
  'format_type' => 'long',
  'fromto' => 'both',
  'multiple_number' => '',
  'multiple_from' => '',
...
$handler->display->display_options['fields']['field_research_excerpt']['id'] = 'field_research_excerpt';
$handler->display->display_options['fields']['field_research_excerpt']['table'] = 'field_data_field_research_excerpt';
$handler->display->display_options['fields']['field_research_excerpt']['field'] = 'field_research_excerpt';
/* Field: Content: Image */
