...
const baseDirBackend = '../backend/project/sites/all/themes/optimhealth/public';

// exclude unnecesary files or folders
const distSrc = ['./dist/**/*', '!./dist/index.html', '!./dist/favicon.ico', '!./dist/robots.txt', '!./dist/images/temp/**/*'];
...
gulp.task('styles', () => {
  return gulp.src('app/styles/*.scss')
    ...
    .pipe($.autoprefixer({browsers: ['last 1 version', 'iOS >= 8']}))
...
gulp.task('serve', ['svg', 'hbs','es6', 'styles', 'fonts'], () => {
  browserSync({
    notify: false,
    port: 9000,
    server: {
...
gulp.task('build', ['svg', 'hbs', 'es6', 'html', 'images', 'fonts', 'extras'], () => {
